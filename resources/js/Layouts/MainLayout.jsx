...
const MainLayout = ({ children, filters: propsFilters }) => {
    ...
    const { isOpen: showChat, closeChat, toggleChat } = useChatStore();
        ...
        <div className="h-screen bg-gray-50 flex flex-col overflow-hidden font-sans">
            ...
            {showChat && (
                <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center pointer-events-none">
                    <div className="absolute inset-0 bg-black/20 backdrop-blur-sm pointer-events-auto" onClick={closeChat} />

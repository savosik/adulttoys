                            ...
                            <div className="lg:col-span-1">
                                <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 sticky top-6">
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                                                        deliveryMethod === 'pickup' ? 'bg-red-500' : 'bg-gray-100'
                                                    }`}>
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                                                        deliveryMethod === 'courier' ? 'bg-red-500' : 'bg-gray-100'
                                                    }`}>
                                                        <Icons.Truck className={`w-5 h-5 ${
                                                            deliveryMethod === 'courier' ? 'text-white' : 'text-gray-600'
                                                        }`} />
                                                    </div>
                                                    <div className="flex-1 min-w-0">
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                                        deliveryMethod === 'post' ? 'bg-red-500' : 'bg-gray-100'
                                                    }`}>
                                                        <Icons.Mail className={`w-5 h-5 ${
                                                            deliveryMethod === 'post' ? 'text-white' : 'text-gray-600'
                                                        }`} />
                                                    </div>
                                                    <div className="flex-1">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="relative">
                                                        <input
                                                            ...
                                                            className={`w-full px-3 py-2.5 pr-10 border rounded-lg focus:ring-2 focus:border-transparent text-sm transition-colors ${
                                                                courierDeliveryErrors.address 
                                    ...
                                    <button 
                                        ...
                                        className={`w-full py-4 rounded-2xl font-bold text-lg transition-all mb-4 relative group ${
